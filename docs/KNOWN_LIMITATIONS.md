...
8. A three-page learner support is now covered. Very tall author-defined response zones can intentionally leave substantial white space; automatic compaction remains outside this lot.
...
12. The final editor performs deliberately simple LaTeX checks for balanced dollars and braces. Full semantic validation still belongs to the real PDF compilation step.
